...
void
GameEngine::join_player(const std::string &player_name)
{
...
void
GameEngine::register_road(const std::string &player_name, const std::string &road_name)
{
...
void
GameEngine::register_town(const std::string &player_name, const std::string &town_name)
{
    if (_stage != GameStage::INFRASTRUCTURES_REGISTRATION){
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
void
GameEngine::register_city(const std::string &player_name, const std::string &city_name)
{
    if (_stage != GameStage::INFRASTRUCTURES_REGISTRATION){
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
void
GameEngine::put_initial_infrastructure(const std::string &player, const std::string &town, Coord town_coord, CrossCorner town_corner,
...
void
GameEngine::make_dice(const std::string &player_name, size_t dice)
{
...
void
GameEngine::drop_resource(const std::string &player_name, Resource resource)
{
...
void
GameEngine::move_robber(const std::string &player_name, Coord coord)
{
...
void
GameEngine::rob(const std::string &player_name, const std::string &victim_name)
{
...
void
GameEngine::exchange_with_field(const std::string &player_name, Resource src, Resource target)
{
...
int
GameEngine::exchange_players_request(const std::string &player_name, const std::string &other_player_name,
                                     const std::multiset<Resource> &src, const std::multiset<Resource> &target)
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
    return second_engine->exchange_players_request(player_name, other_player_name, src, target);
}

void
GameEngine::exchange_players_accept(const std::string &player_name, int request)
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
void
GameEngine::end_exchanges(const std::string &player_name)
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
const Player &
GameEngine::initiator(int request) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
const Player &
GameEngine::other(int request) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
GameEngine::src(int request) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
const std::multiset<Resource> &
GameEngine::target(int request) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
bool
GameEngine::requested(int number) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
bool
GameEngine::performed(int request) const
{
    if (_stage != GameStage::STAGE2) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
void
GameEngine::build_road(const std::string &player_name, const std::string &road_name,
...
void
GameEngine::build_town(const std::string &player_name, const std::string &town_name,
...
void
GameEngine::build_city(const std::string &player_name, const std::string &city_name,
           Coord coord, CrossCorner corner)
{
    if (_stage != GameStage::STAGE3){
        throw std::invalid_argument("The game is on the wrong stage");
...
void
GameEngine::next_player(const std::string &player_name)
{
    if (_stage != GameStage::STAGE3){
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
int
GameEngine::score(const std::string &player_name)
{
    if (_stage == GameStage::PLAYERS_REGISTRATION) {
        throw std::invalid_argument("The game is on the wrong stage");
    }
...
const Game &
GameEngine::game() const noexcept
{
    return *_game;
}

const Player &
GameEngine::current_player() const
{
    if (_stage == GameStage::PLAYERS_REGISTRATION ||
        _stage == GameStage::FINAL_STAGE){
        throw std::invalid_argument("The game is on the wrong stage");
...
GameStage
GameEngine::stage() const noexcept
{
    return _stage;
}

void
GameEngine::switch_engine()
{
