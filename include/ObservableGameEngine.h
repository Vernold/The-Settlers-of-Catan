#ifndef ObservableGameEngine_h
#define ObservableGameEngine_h
...
class ObservableGameEngine: public IGameEngine
{
...
public:
    ...
    ObservableGameEngine(const ObservableGameEngine &) = delete;
    ObservableGameEngine &operator=(const ObservableGameEngine &) = delete;
